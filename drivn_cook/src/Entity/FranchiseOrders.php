...
class FranchiseOrder
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Product", inversedBy="idFranchiseOrder")
    ...
    public function setIdFranchise(?Franchise $idFranchise): self
    {
    ...
    public function setIdWarehouse(?Warehouse $idWarehouse): self
    {
