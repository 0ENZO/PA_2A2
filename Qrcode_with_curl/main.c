...
void enterfirstname(GtkWidget *widget,GtkWidget *entry)
{
    firstnamechar = gtk_entry_get_text(GTK_ENTRY(entry));
}

void enterlastname(GtkWidget *widget,GtkWidget *entry)
{
    lastnamechar = gtk_entry_get_text(GTK_ENTRY(entry));
}

void enterphonenumber(GtkWidget *widget,GtkWidget *entry)
{
